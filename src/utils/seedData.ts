...
export async function seedInitialData() {
  const tiposCultivo = [
    ...
    },
    {
      ...
      info_luz: 'Pleno sol. Sembrar en primavera',
    ...
    },
    {
      ...
      temp_germinacion_max: 25,
      temp_crecimiento_min: 10,
      temp_crecimiento_max: 25,
      info_plagas: 'Pulgones, araña roja, nematodos, botrytis. Usar plantas certificadas y buena ventilación.',
      info_suelo: 'Suelo ácido, bien drenado, rico en materia orgánica. pH 5.5-6.5.',
      info_riego: 'Riego regular, mantener suelo húmedo pero no encharcado. Riego por goteo ideal.',
      info_luz: 'Pleno sol, mínimo 6 horas de luz directa.',
      info_general: 'Perenne que produce frutos por 2-3 años. Mejor plantar en otoño o primavera. Proteger frutos del contacto con suelo usando paja.',
    },
    {
      nombre: 'Sarandaja',
      nombre_cientifico: 'Vigna unguiculata',
      familia: 'Fabaceae',
      dias_germinacion: 7,
      dias_cosecha: 70,
      temp_germinacion_min: 18,
      ...
      temp_crecimiento_min: 15,
      temp_crecimiento_max: 35,
      info_plagas: 'Pulgones, mosca blanca, gorgojos. Rotación de cultivos y control biológico.',
      info_suelo: 'Suelo bien drenado, tolera suelos pobres. pH 6.0-7.0. Fija nitrógeno.',
      info_riego: 'Riego moderado, tolera sequía. Riego más frecuente durante floración.',
      info_luz: 'Pleno sol.',
      info_general: 'Leguminosa de crecimiento rápido. Puede necesitar tutor. Mejora el suelo fijando nitrógeno. Cosechar vainas tiernas.',
    },
    {
      nombre: 'Rabanitos',
      ...
      temp_crecimiento_min: 8,
      temp_crecimiento_max: 24,
      info_plagas: 'Pulguilla, mosca de la col, pulgones. Usar mallas anti-insectos y rotación de cultivos.',
      info_suelo: 'Suelo suelto, ligero, sin piedras. pH 6.0-7.0.',
      info_riego: 'Riego frecuente y ligero. Mantener humedad constante para evitar raíces fibrosas.',
      info_luz: 'Sol a sombra parcial. Tolera algo de sombra.',
      info_general: 'Cultivo de ciclo muy corto, ideal para intercalar entre otros. Sembrar directamente, no trasplantar. Cosechar cuando el bulbo asome sobre la tierra.',
    },
    {
      nombre: 'Nabos',
      nombre_cientifico: 'Brassica rapa',
      familia: 'Brassicaceae',
      dias_germinacion: 7,
      dias_cosecha: 60,
      temp_germinacion_min: 10,
      temp_germinacion_max: 25,
      temp_crecimiento_min: 5,
      temp_crecimiento_max: 22,
      info_plagas: 'Pulguilla, mosca de la col, pulgones, orugas. Usar mallas anti-insectos y Bacillus thuringiensis.',
      info_suelo: 'Suelo profundo, suelto, bien drenado. pH 6.0-7.5.',
      info_riego: 'Riego regular y constante. Evitar sequía para que las raíces no se vuelvan leñosas.',
      info_luz: 'Pleno sol a sombra parcial.',
      info_general: 'Cultivo de clima fresco. Sembrar en otoño o primavera. Se aprovechan tanto las raíces como las hojas. Ralear dejando 10-15cm entre plantas.',
    },
    {
      nombre: 'Ají Rojo',
      nombre_cientifico: 'Capsicum baccatum',
      familia: 'Solanaceae',
      dias_germinacion: 14,
      dias_cosecha: 120,
      temp_germinacion_min: 20,
      ...
      temp_crecimiento_min: 18,
      temp_crecimiento_max: 35,
      info_plagas: 'Pulgones, mosca blanca, araña roja, trips. Control biológico y trampas cromáticas amarillas.',
      info_suelo: 'Suelo fértil, bien drenado, rico en materia orgánica. pH 6.0-7.0.',
      info_riego: 'Riego regular, evitar encharcamiento. Reducir riego en maduración para concentrar sabor.',
      info_luz: 'Pleno sol, mínimo 6-8 horas de luz directa.',
      info_general: 'Ají picante de clima cálido. Sembrar en semillero y trasplantar cuando tenga 4-6 hojas. Puede necesitar tutor. Cosechar cuando los frutos estén rojos.',
    },
    {
      nombre: 'Ají Amarillo',
      nombre_cientifico: 'Capsicum baccatum var. pendulum',
      familia: 'Solanaceae',
      dias_germinacion: 14,
      dias_cosecha: 130,
      temp_germinacion_min: 20,
      temp_germinacion_max: 30,
      temp_crecimiento_min: 18,
      temp_crecimiento_max: 32,
      info_plagas: 'Pulgones, mosca blanca, araña roja, trips. Control biológico y trampas cromáticas.',
      info_suelo: 'Suelo fértil, bien drenado, rico en materia orgánica. pH 6.0-7.0.',
      info_riego: 'Riego regular y constante. Evitar estrés hídrico durante floración y fructificación.',
      info_luz: 'Pleno sol, mínimo 6-8 horas de luz directa.',
      info_general: 'Ají peruano emblemático, picor moderado y aroma afrutado. Sembrar en semillero protegido. Trasplantar con clima cálido estable. Puede necesitar tutor.',
    },
    {
      nombre: 'Kale',
      nombre_cientifico: 'Brassica oleracea var. sabellica',
      familia: 'Brassicaceae',
      dias_germinacion: 7,
      dias_cosecha: 65,
      temp_germinacion_min: 10,
      ...
      temp_crecimiento_min: 5,
      temp_crecimiento_max: 24,
      info_plagas: 'Orugas, pulgones, mosca blanca, pulguilla. Usar mallas anti-insectos y Bacillus thuringiensis.',
      info_suelo: 'Suelo fértil, rico en nitrógeno y materia orgánica. pH 6.0-7.5.',
      info_riego: 'Riego regular, mantener suelo húmedo. Tolerante a condiciones variables.',
      info_luz: 'Pleno sol a sombra parcial.',
      info_general: 'Col rizada muy resistente al frío, mejora su sabor tras heladas. Cosechar hojas exteriores dejando el centro crecer. Cultivo productivo durante meses.',
    },
  ];
